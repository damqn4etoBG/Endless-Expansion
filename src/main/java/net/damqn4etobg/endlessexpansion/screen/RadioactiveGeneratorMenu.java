...
public class RadioactiveGeneratorMenu extends AbstractContainerMenu {
    public final RadioactiveGeneratorBlockEntity blockEntity;
    ...
    public RadioactiveGeneratorMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.RADIOACTIVE_GENERATOR_MENU.get(), id);
        checkContainerSize(inv, 2);
        blockEntity = (RadioactiveGeneratorBlockEntity) entity;
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(handler ->{
            this.addSlot(new SlotItemHandler(handler, 0, 80, 36));
            this.addSlot(new SlotItemHandler(handler, 1, 40, 36));
        });
    ...
    public int getScaledProgress() {
        ...
        int progressArrowSize = 9; // This is the height in pixels of your arrow
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, ModBlocks.RADIOACTIVE_GENERATOR.get());
    }

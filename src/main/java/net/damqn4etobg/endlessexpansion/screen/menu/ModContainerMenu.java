...
public abstract class ModContainerMenu extends AbstractContainerMenu {
    protected ModContainerMenu(@Nullable MenuType<?> pMenuType, int pContainerId) {
    ...
    protected int BE_INVENTORY_SLOT_COUNT;  // number of block entity slots

    // Credit: https://github.com/diesieben07/SevenCommons
    @Override

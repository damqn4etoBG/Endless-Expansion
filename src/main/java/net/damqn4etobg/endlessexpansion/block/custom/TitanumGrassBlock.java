...
public class TitanumGrassBlock extends GrassBlock {
    ...
    public void randomTick(BlockState p_222508_, ServerLevel p_222509_, BlockPos p_222510_, RandomSource p_222511_) {
        if (!canBeGrass(p_222508_, p_222509_, p_222510_)) {
            ...
            p_222509_.setBlockAndUpdate(p_222510_, ModBlocks.TITANUM_SOIL.get().defaultBlockState());
        } else {
            ...
            if (p_222509_.getMaxLocalRawBrightness(p_222510_.above()) >= 9) {
                ...
                for(int i = 0; i < 4; ++i) {
                    ...
                    if (p_222509_.getBlockState(blockpos).is(ModBlocks.TITANUM_SOIL.get()) && canPropagate(blockstate, p_222509_, blockpos)) {

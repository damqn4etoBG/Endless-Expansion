...
public class MysticalCobaltBoltItem extends ArrowItem {
    public final float damage;

    public MysticalCobaltBoltItem(Properties pProperties, float damage) {
        super(pProperties);
        this.damage = damage;
    }
    ...
    public AbstractArrow createArrow(Level pLevel, ItemStack pStack, LivingEntity pShooter) {
        MysticalCobaltBolt bolt = new MysticalCobaltBolt(pLevel, pShooter);
    ...
    public InteractionResult interactLivingEntity(ItemStack pStack, Player pPlayer, LivingEntity pInteractionTarget, InteractionHand pUsedHand) {
        ...
        if(crossbow.getItem() instanceof CrossbowItem) {
            ...
            tag.putBoolean("MysticalCobaltBolt", true);
        }

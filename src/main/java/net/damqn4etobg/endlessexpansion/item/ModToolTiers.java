...
public class ModToolTiers {
    public static final Tier COBALT = TierSortingRegistry.registerTier(
            ...
            ResourceLocation.fromNamespaceAndPath(EndlessExpansion.MODID, "cobalt"), List.of(Tiers.DIAMOND), List.of());
    ...
    public static final Tier CELESTIAL = TierSortingRegistry.registerTier(
            ...
            ResourceLocation.fromNamespaceAndPath(EndlessExpansion.MODID, "celestial"), List.of(ModToolTiers.COBALT), List.of());
    ...
    public static final Tier SHADOWSTEEL = TierSortingRegistry.registerTier(
            ...
            ResourceLocation.fromNamespaceAndPath(EndlessExpansion.MODID, "shadowsteel"), List.of(ModToolTiers.CELESTIAL), List.of());
}
